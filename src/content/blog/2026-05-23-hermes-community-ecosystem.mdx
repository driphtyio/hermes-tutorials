...
description: "The Hermes Agent ecosystem exploded via the Skills Hub (310+ workflows), awesome-hermes-skills (78 community skills), and hermes-skills repo (310+ skills). Third-party tools include hermes-vscode (VS Code chat), hermes-go (Go port with RAG/memory), and awesome-hermes-usecases (curated real-world examples). Practical community skills like hermes-merchant (auto-fills job applications) and hermes_stack (local knowledge graph integration) drive adoption. Installation supports taps, security scann..."
pubDate: 2026-05-23
tags: ["hermes", "update"]
