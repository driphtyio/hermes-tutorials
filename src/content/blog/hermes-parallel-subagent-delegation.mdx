...
description: "Run concurrent subagents in Hermes Agent with the delegate_task tasks array — cut wall-clock time from the sum of all tasks to the slowest single one."
pubDate: 2026-07-27
tags: [hermes, tutorial, subagents, delegation, parallel, multi-agent, configuration]
heroImage: "https://pub-0066f5275194430aa9f985cb23278abe.r2.dev/hermes-parallel-subagent-delegation-1785367728.webp"
