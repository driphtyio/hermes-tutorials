...
description: "Persistent memory is a frozen snapshot: MEMORY.md (2,200 chars) and USER.md (1,375 chars) in ~/.hermes/memories/, §-separated, injected once per session…"
pubDate: 2026-08-20
