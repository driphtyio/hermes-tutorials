...
[1] [—official Tool Gateway docs](https://hermes-agent.nousresearch.com/docs/guides/tool-gateway)
[2] [hermes-agent.nousresearch.com/docs/guides/portal-setup](https://hermes-agent.nousresearch.com/docs/guides/portal-setup)
[3] [—config reference](https://hermes-agent.nousresearch.com/docs/guides/portal-setup#tool-gateway-config)
