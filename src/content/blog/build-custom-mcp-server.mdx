...
[2] [Hermes MCP guide](https://hermes-agent.nousresearch.com/docs/guides/use-mcp-with-hermes)
[3] [MCP tool specification](https://modelcontextprotocol.io/docs/concepts/tools)
