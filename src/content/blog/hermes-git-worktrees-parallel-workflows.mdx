...
pubDate: "2026-07-31"
heroImage: "https://pub-0066f5275194430aa9f985cb23278abe.r2.dev/hermes-git-worktrees-parallel-workflows-1785523593.webp"
...
[2] [Hermes treats your current working directory as the project root](https://hermes-agent.nousresearch.com/docs/user-guide/git-worktrees)
[3] [each worktree gets its own branch, working directory, AND separate Checkpoint Manager history](https://hermes-agent.nousresearch.com/docs/user-guide/checkpoints-and-rollback)
