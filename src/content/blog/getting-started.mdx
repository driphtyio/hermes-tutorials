...
<nav aria-label="Breadcrumb" class="breadcrumb">
  <a href="/">Home</a> &rsaquo; <a href="/blog">Quick Start Guides</a> &rsaquo; <span>Getting Started</span>
</nav>
...
3. Enables the Tool Gateway — web search, image generation, TTS, and a cloud browser — all through one subscription
...
This walks you through an interactive menu of all supported providers. Some popular choices:
...
You rarely need to touch these files directly — the CLI handles it:
...
If all of the above works, you've cleared the hardest part.
...
HERO_IMAGE_PROMPT: A modern, clean hero image showing a terminal window with "hermes setup --portal" being executed, surrounded by icons representing the Hermes Agent ecosystem — a brain (AI/learning loop), chat bubbles (messaging platforms), a shield (security), and a gear (automation) — all connected by flowing lines, on a dark gradient background with purple and gold accents matching the Nous Research brand.
