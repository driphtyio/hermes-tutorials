---
title: "Build a Compound Engineering Workflow in Hermes Agent"
description: "Step-by-step guide to implementing Every Inc's Compound Engineering methodology using Hermes Agent — mapping /ce-* commands to Hermes skills and cron jobs."
pubDate: 2026-06-01
tags: ["compound-engineering", "hermes-agent", "workflow", "tutorial"]
heroImage: "https://pub-0066f5275194430aa9f985cb23278abe.r2.dev/build-compound-engineering-workflow-hermes-agent-1781668040.jpg"
---
...
The methodology was created by Every Inc and is detailed in their [Chain of Thought article](https://every.to/chain-of-thought/compound-engineering-how-every-codes-with-agents). The open-source implementation is at [github.com/EveryInc/compound-engineering-plugin](https://github.com/EveryInc/compound-engineering-plugin).
...
{/* Note: The Compound Engineering plugin uses Claude Code's slash command system. Hermes Agent uses a different interface, but the underlying workflow patterns translate directly. */}
...
1. Read the full [Compound Engineering article](https://every.to/chain-of-thought/compound-engineering-how-every-codes-with-agents) for context
2. Browse the [plugin source](https://github.com/EveryInc/compound-engineering-plugin) for workflow patterns
